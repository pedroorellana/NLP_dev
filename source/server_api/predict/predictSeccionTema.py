...
class PredictSeccionTema:
    ...
    def predict(self, text_input):
        ...
        y_test_hat , pred_prob = self.sec1.calcPred( vec_input = feat_vec)        
        ...
        y_test_hat_tema , pred_prob_tema = tema1.calcPred( vec_input = feat_vec)
        
        #print( "seccion : " +y_test_hat+ "\ntema: "+y_test_hat_tema + "\n")
        return (y_test_hat, y_test_hat_tema)
